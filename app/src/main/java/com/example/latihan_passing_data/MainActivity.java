package com.example.latihan_passing_data;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvResult.setText(String.format("Hasil : %s", 0));
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Ariq Hikari Hidayat");
            ...
            case R.id.btn_move_activity_object:
                ...
                mPerson.setName("Ariq Hikari Hidayat");
                mPerson.setAge(17);
                mPerson.setEmail("ariqhikari@gmail.com");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "085156567283";
